    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-compact nav-flat" data-widget="treeview" role="menu"
                ...
                ?>
                <li class="<?= $li ?>"><a class="<?= $a ?>" href="<?php echo Url::toRoute(['/site/index']); ?>"><i
                ...
                <li class="<?= $li; ?>"><a class="<?= $a; ?>" href="#"><i class="nav-icon fas fa-users"></i>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="<?= $li; ?>"><a class="<?= $a; ?>"
                                href="<?php echo Url::toRoute(['/users/users/index']); ?>"><i
                        ...
                        ?>
                        <li class="<?= $li; ?>"><a class="<?= $a; ?>"
                                href="<?php echo Url::toRoute(['/rbac/route']); ?>"><i
                        ...
                        ?>
                        <li class="<?= $li; ?>"><a class="<?= $a; ?>"
                                href="<?php echo Url::toRoute(['/rbac/permission']); ?>"><i
                                    class="nav-icon far fa-circle text-purple"></i>
                        ...
                        ?>
                        <li class="<?= $li; ?>"><a class="<?= $a; ?>"
                                href="<?php echo Url::toRoute(['/rbac/role']); ?>"><i
                        ...
                        ?>
                        <li class="<?= $li; ?>"><a class="<?= $a; ?>"
                                href="<?php echo Url::toRoute(['/rbac/assignment']); ?>"><i
                                    class="nav-icon far fa-circle text-yellow"></i>
                                <p>Asignar rol </p>
                            </a></li>
                    </ul>
                ...
                <li class="<?= $li; ?>"><a class="<?= $a; ?>" href="#"><i class="nav-icon fas fa-file-code"></i>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        ?>
                        <li class="<?= $li; ?>"><a class="<?= $a; ?>" href="<?php echo Url::toRoute(['/gii']); ?>"
                                target="_blank"><i class="nav-icon far fa-circle text-danger"></i>
                                <p>Gii </p>
                            </a></li>
                        ...
                        ?>
                        <li class="<?= $li; ?>"><a class="<?= $a; ?>" href="<?php echo Url::toRoute(['/debug']); ?>"
                                target="_blank"><i class="nav-icon far fa-circle text-blue"></i>
                                <p>Debug </p>
                            </a></li>
                    </ul>
                </li>
